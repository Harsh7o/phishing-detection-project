    ...
    if any(word in url for word in suspicious_keywords) or \
       ...
       len(url) > 60 or url.count("-") > 3:
        ...
        try:
            ...
            if prediction[0] == 1:
                result = "⚠️ Phishing Website Detected"
                reason = "ML model flagged this URL as phishing."
            else:
                result = "✅ Safe Website"
                reason = "No suspicious patterns detected."
        except Exception as e:
            # In case the URL can't be processed
            result = "⚠️ Phishing Website Detected"
            reason = "URL appears highly suspicious."
